...
<section class="content" style="margin-bottom: 40px;padding-top:0" ng-app="myApp" ng-controller="myCtrl" ng-cloak>
  ...
  <div class="alert_box" ng-click="alert_box()">
    <div class="alert_box_top">
      ...
      <!-- //表单声明元素 -->
      <input type="text" class="selectPage_box" placeholder='请选择预警类型' id="category_select">
    ...
    <div class="row" style="margin:0;padding:24px 0" ng-click="blur_input()">
      ...
      <p>
        <em style="font-size: 14px;padding-left:36px;color: #BBBBBB;">共有<span ng-bind="pages.count"></span>条预警</em>
      </p>
