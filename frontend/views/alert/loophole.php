            ...
            <div class="row" style="margin:0;padding:24px 0" ng-click="blur_input()">
                ...
                <div style="padding: 0px; position: relative;height:60px;">
                    ...
                    <ul class="pagination pagination-sm  pull-right ng-cloak" style="margin-right:36px;">
                        ...
                        <li><a href="javascript:void(0);" ng-click="loop_serch(loophole.pageNow-2)"
                                ng-bind="loophole.pageNow-2" ng-if="loophole.pageNow>3"></a></li>
                        <li><a href="javascript:void(0);" ng-click="loop_serch(loophole.pageNow-1)"
                                ng-bind="loophole.pageNow-1" ng-if="loophole.pageNow>2"></a></li>
                        <li class="active"><a href="javascript:void(0);" ng-bind="loophole.pageNow"></a></li>
                        <li><a href="javascript:void(0);" ng-click="loop_serch(loophole.pageNow+1)"
                                ng-bind="loophole.pageNow+1" ng-if="loophole.pageNow<loophole.maxPage-1"></a></li>
                        <li><a href="javascript:void(0);" ng-click="loop_serch(loophole.pageNow+2)"
                                ng-bind="loophole.pageNow+2" ng-if="loophole.pageNow<loophole.maxPage-2"></a></li>
                        <li><a href="javascript:void(0);" ng-if="loophole.pageNow<loophole.maxPage-3">...</a></li>

                        <li><a href="javascript:void(0);" ng-click="loop_serch(loophole.maxPage)"
                                ng-bind="loophole.maxPage" ng-if="loophole.pageNow<loophole.maxPage"></a></li>
                        <li><a href="javascript:void(0);" ng-click="loop_serch(loophole.pageNow+1)"
