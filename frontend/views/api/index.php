    ...
    <div>
      <table class="table table_th  table-striped ng-cloak">
        ...
        <tr class="alert_table_tr" style="cursor: pointer;" ng-repeat="item in api_list.data">
          ...
          <td>
            <span>
              {{item.start_time*1000| date:'yyyy-MM-dd'}}
            </span>
            <span>-</span>
            <span>
              {{item.end_time*1000| date:'yyyy-MM-dd'}}
            </span>
          </td>
      ...
      <div style="padding: 25px;">
        ...
        <ul class="pagination pagination-sm no-margin pull-right ng-cloak">
          <li>
            <a href="javascript:void(0);" ng-click="get_api_list(api_list.pageNow-1)" ng-if="api_list.pageNow>1">上一页</a>
          </li>
          <li>
          ...
          <li>
            <a href="javascript:void(0);" ng-click="get_api_list(api_list.pageNow-2)" ng-bind="api_list.pageNow-2"
              ng-if="api_list.pageNow>3"></a>
          </li>
          <li>
            <a href="javascript:void(0);" ng-click="get_api_list(api_list.pageNow-1)" ng-bind="api_list.pageNow-1"
              ng-if="api_list.pageNow>2"></a>
          </li>
          <li class="active">
          ...
          <li>
            <a href="javascript:void(0);" ng-click="get_api_list(api_list.pageNow+1)" ng-bind="api_list.pageNow+1"
              ng-if="api_list.pageNow<api_list.maxPage-1"></a>
          </li>
          <li>
            <a href="javascript:void(0);" ng-click="get_api_list(api_list.pageNow+2)" ng-bind="api_list.pageNow+2"
              ng-if="api_list.pageNow<api_list.maxPage-2"></a>
          </li>
          <li>
            <a href="javascript:void(0);" ng-if="api_list.pageNow<api_list.maxPage-3">...</a>
          </li>
          <li>
            <a href="javascript:void(0);" ng-click="get_api_list(api_list.maxPage)" ng-bind="api_list.maxPage"
              ng-if="api_list.pageNow<api_list.maxPage"></a>
          </li>
          <li>
    ...
    <div id="token">
      ...
      <div class="token_mid">
        ...
        <div class="log_time">
          ...
          <input class="token_top_input" autocomplete="off" id="picker_add" type="text" placeholder="时间">
        </div>
      </div>
      <div class="token_bom">
