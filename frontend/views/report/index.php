  ...
  <div class="report_container">
    <div class="report_container_top">
      ...
      <div class="search_time ">
        ...
        <input class="input_box_report" autocomplete="off" id="picker_search" type="text" placeholder="时间">
      </div>
    </div>
    ...
    <div style="padding: 25px;">
      ...
      <ul class="pagination pagination-sm no-margin pull-right ng-cloak">
        ...
        <li>
          <a href="javascript:void(0);" ng-click="get_report_list(report_list.maxPage)" ng-bind="report_list.maxPage"
            ng-if="report_list.pageNow<report_list.maxPage"></a>
        </li>
        <li>
          <a href="javascript:void(0);" ng-click="get_report_list(report_list.pageNow+1)"
