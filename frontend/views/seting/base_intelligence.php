        ...
        <div id="vehicle_loophole">
            <ul class="l_mid">
              ...
              <li class="item">
                    ...
                    <span class="stance">{{base_data.cvss_v2}}<span ng-hide="base_data.cvss_v2== ''">Critical</span></span>
              </li>
               <li class="item">
                    <img class="i_img" src="/images/loophole/sp10.png" alt=""/>
                    <h4 class="title">CVSS v3：</h4>
                    <span class="stance">{{base_data.cvss_v3}}<span ng-hide="base_data.cvss_v3== ''">High</span></span>
                </li>
                <li class="item">
