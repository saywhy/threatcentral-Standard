  ...
  <div class="log_box">
    <div class="log_box_top">
      <div class="log_input_box">
        <div class="log_time">
          <img src="/images/report/time.png" class="log_time_icon" alt="">
    ...
    <div class="log_box_table">
      ...
      <div style="padding: 25px;">
        ...
        <ul class="pagination pagination-sm no-margin pull-right ng-cloak">
          ...
          <li>
            <a href="javascript:void(0);" ng-click="get_page_list(page_list.pageNow-2)" ng-bind="page_list.pageNow-2"
              ng-if="page_list.pageNow>3"></a>
          </li>
          <li>
            <a href="javascript:void(0);" ng-click="get_page_list(page_list.pageNow-1)" ng-bind="page_list.pageNow-1"
              ng-if="page_list.pageNow>2"></a>
          </li>
          <li class="active">
          ...
          <li>
            <a href="javascript:void(0);" ng-click="get_page_list(page_list.pageNow+1)" ng-bind="page_list.pageNow+1"
              ng-if="page_list.pageNow<page_list.maxPage-1"></a>
          </li>
          <li>
            <a href="javascript:void(0);" ng-click="get_page_list(page_list.pageNow+2)" ng-bind="page_list.pageNow+2"
              ng-if="page_list.pageNow<page_list.maxPage-2"></a>
          </li>
          <li>
            <a href="javascript:void(0);" ng-if="page_list.pageNow<page_list.maxPage-3">...</a>
          </li>
          <li>
            <a href="javascript:void(0);" ng-click="get_page_list(page_list.maxPage)" ng-bind="page_list.maxPage"
              ng-if="page_list.pageNow<page_list.maxPage"></a>
          </li>
          <li>
            <a href="javascript:void(0);" ng-click="get_page_list(page_list.pageNow+1)"
