...
<body>
  <div ng-app="myApp" ng-controller="registerCtrl" ng-cloak>
      ...
      <div class="col-md-6" style="position: relative;height: 100%;">
        ...
        <div class="login_box_content">
          ...
          <div class="input_box">
            ...
            <input id="pswd" class="input_css" ng-focus="password_focus()" placeholder="请输入密码" type="password"
          ...
          <div class="input_box">
            <label for="pswd">确认密码</label>
            <img src="/images/login/pswd.png" class="user_img" alt="">
            <input id="pswd" class="input_css" ng-focus="repassword_focus()" placeholder="请确认密码" type="password"
              ng-model="user.repassword">
            <div class="error_msg">
              <p class="errorMessage_color">
                  <span ng-bind="errorMessage.repassword"></span>
              </p>
            </div>
          </div>
          <!-- <div>
          ...
          <button ng-click="login_in()" class="login_button">创建管理员</button>
        </div>
        <p style="position: absolute; bottom: 20px;left: 50%;transform: translateX(-50%);">
          <span style="color:#666;">
            &copy;虎特信息科技（上海）有限公司 版权所有</span>
        </p>
      </div>
      <div class="col-md-6">
